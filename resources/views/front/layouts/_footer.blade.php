<footer class="footer footer-dark">
    ...
    <div class="footer-bottom">
        <div class="container">
            <p class="footer-copyright">Copyright © 2024 E-Commerce Store. All Rights Reserved.</p>

            <figure class="footer-payments">
                <img src="{{ url('front/assets/images/payments.png') }}" alt="Payment methods" width="272"
                    height="20">
            </figure>
        </div>
    </div>
